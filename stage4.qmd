...
The four "Current Topics" modules contain a number of option topics, allowing you to choose what you want to study. These topics will be described at the start of each module, so you don't need to make any choices beforehand. The current list of option topics, together with descriptions, can be found [here](https://plymouthpsychology.github.io/options/).
