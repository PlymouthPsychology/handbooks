...
· Familiarising yourself with practice exam questions
...
General criteria for marking written work are provided in this handbook. These apply to longer exam answers as well as coursework. For multiple choice exams (used in Stage 1) marking processes are described [here](https://plymouthpsychology.github.io/handbooks/mcq_exams.html).
...
A: No. Modules containing exams run within one semester. Each module is examined in the examination weeks within the semester in which it was taught.
...
A: An exam can contain questions on material covered in lectures, readings, or other material provided by the lecturer.
...
A: Extenuating circumstances will only cover you for missing an exam. If you decide to sit an exam, the mark will stand even if you do not do as well as you know you could. This could result in failing a module.
...
A: The outline for every module is on the module's DLE page.
