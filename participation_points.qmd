...
The School considers that experience of being a participant in research is almost essential to running one's own research on others, and to evaluating the psychological research literature. However, in exceptional cases there might be reasons why a student cannot act as a participant, e.g. because of a disability. For these students there is an alternative way to pass PSYC424 and PSYC526: you can write an extended essay on a topic that will be provided at the start of the module. The deadline for submission of the essay will be stated on the DLE page for the module. Also remember that if you fail to collect enough participation points or do not complete the alternative essay on time, then you will fail the module.
